...
class TestLoFiGenerator:
    ...
    def test_batch_generate_without_variety(self, mock_model, mock_tokenizer, test_config, temp_dir):
    ...
    def test_calculate_quality_score_length_penalty(
        self, mock_model, mock_tokenizer, test_config
    ):
    ...
    def test_calculate_quality_score_diversity(
        self, mock_model, mock_tokenizer, test_config
    ):
    ...
    def test_calculate_quality_score_tempo_bonus(
        self, mock_model, mock_tokenizer, test_config
    ):
